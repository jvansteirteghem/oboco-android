...
- install [the latest release](https://gitlab.com/jeeto/oboco-android/-/jobs/artifacts/3d2e0a16/raw/app/build/outputs/apk/release/app-release.apk?job=assembleRelease).
