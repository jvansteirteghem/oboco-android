...
- install [the latest release](https://gitlab.com/jeeto/oboco-android/-/jobs/artifacts/2e9d5332/raw/app/build/outputs/apk/release/app-release.apk?job=assembleRelease).
