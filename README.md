...
- install [the latest release](https://gitlab.com/jeeto/oboco-android/-/jobs/artifacts/master/raw/app/build/outputs/apk/release/app-release.apk?job=assembleRelease).
