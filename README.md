...
- install [the latest release](https://gitlab.com/jeeto/oboco-android/-/jobs/artifacts/d458d2a9/raw/app/build/outputs/apk/release/app-release.apk?job=assembleRelease).
